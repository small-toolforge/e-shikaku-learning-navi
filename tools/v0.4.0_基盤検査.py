...
def main() -> int:
    ...
    checks = {
        ...
        "開発運用カード版を優先表示": "DEVELOPMENT_OPERATIONS_CARDS_VERSION" in cards_ui,
    ...
    if "v0.4.0-dev9" in sw:
        ok.append("Service Workerキャッシュ世代: v0.4.0-dev9")
    else:
        ng.append("Service Workerキャッシュ世代がv0.4.0-dev9ではありません")
